...
/* { dg-final { scan-assembler-times "call _printf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vprintf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _fprintf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vfprintf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _sprintf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _snprintf_cdopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_cdopuxX"  1 } } */
