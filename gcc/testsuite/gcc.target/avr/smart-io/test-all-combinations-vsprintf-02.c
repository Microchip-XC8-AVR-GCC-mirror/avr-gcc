...
/* { dg-final { scan-assembler-times "call _vsprintf_s"  1 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_gGs"  2 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_fFgGs"  4 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_eEfFgGs"  8 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_cdeEfFgGnopsuxX"  16 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_aAcdeEfFgGnopsuxX"  32 } } */
