...
/* { dg-final { scan-assembler-times "call _printf_s"  1 } } */
/* { dg-final { scan-assembler-times "call _printf_gGs"  2 } } */
/* { dg-final { scan-assembler-times "call _printf_fFgGs"  4 } } */
/* { dg-final { scan-assembler-times "call _printf_eEfFgGs"  8 } } */
/* { dg-final { scan-assembler-times "call _printf_cdeEfFgGnopsuxX"  16 } } */
/* { dg-final { scan-assembler-times "call _printf_aAcdeEfFgGnopsuxX"  32 } } */
