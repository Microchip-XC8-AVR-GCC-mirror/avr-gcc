...
/* { dg-final { scan-assembler-times "call _vsnprintf_ns"  2 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_gGns"  4 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_fFgGns"  8 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_eEfFgGns"  16 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_cdeEfFgGnopsuxX"  32 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_aAcdeEfFgGnopsuxX"  64 } } */
