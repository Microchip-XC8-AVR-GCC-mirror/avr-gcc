...
/* { dg-final { scan-assembler-times "call _vfscanf_s"  1 } } */
/* { dg-final { scan-assembler-times "call _vfscanf_gGs"  2 } } */
/* { dg-final { scan-assembler-times "call _vfscanf_fFgGs"  4 } } */
/* { dg-final { scan-assembler-times "call _vfscanf_eEfFgGs"  8 } } */
/* { dg-final { scan-assembler-times "call _vfscanf_cdeEfFgGnopsuxX"  16 } } */
/* { dg-final { scan-assembler-times "call _vfscanf_aAcdeEfFgGnopsuxX"  32 } } */
