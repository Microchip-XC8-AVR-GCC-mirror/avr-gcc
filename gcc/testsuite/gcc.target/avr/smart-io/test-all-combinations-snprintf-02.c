...
/* { dg-final { scan-assembler-times "call _snprintf_s"  1 } } */
  /* { dg-final { scan-assembler-times "call _snprintf_gGs"  2 } } */
/* { dg-final { scan-assembler-times "call _snprintf_fFgGs"  4 } } */
/* { dg-final { scan-assembler-times "call _snprintf_eEfFgGs"  8 } } */
/* { dg-final { scan-assembler-times "call _snprintf_cdeEfFgGnopsuxX"  16 } } */
/* { dg-final { scan-assembler-times "call _snprintf_aAcdeEfFgGnopsuxX"  32 } } */
