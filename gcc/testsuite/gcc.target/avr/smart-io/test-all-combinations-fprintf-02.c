...
/* { dg-final { scan-assembler-times "call _fprintf_gG"  2 } } */
/* { dg-final { scan-assembler-times "call _fprintf_gGs"  1 } } */
/* { dg-final { scan-assembler-times "call _fprintf_fFgGs"  4 } } */
/* { dg-final { scan-assembler-times "call _fprintf_eEfFgGs"  8 } } */
/* { dg-final { scan-assembler-times "call _fprintf_cdeEfFgGnopsuxX"  16 } } */
/* { dg-final { scan-assembler-times "call _fprintf_aAcdeEfFgGnopsuxX"  32 } } */
