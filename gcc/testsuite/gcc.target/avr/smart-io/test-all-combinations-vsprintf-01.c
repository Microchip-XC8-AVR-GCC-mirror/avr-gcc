...
void test_1() { vsprintf (buf, QUOTE(FMT_1), _va); }
void test_2() { vsprintf (buf, QUOTE(FMT_2), _va); }
void test_3() { vsprintf (buf, QUOTE(FMT_3), _va); }
void test_4() { vsprintf (buf, QUOTE(FMT_4), _va); }
void test_5() { vsprintf (buf, QUOTE(FMT_5), _va); }
void test_6() { vsprintf (buf, QUOTE(FMT_6), _va); }
void test_7() { vsprintf (buf, QUOTE(FMT_7), _va); }
void test_8() { vsprintf (buf, QUOTE(FMT_8), _va); }
void test_9() { vsprintf (buf, QUOTE(FMT_9), _va); }
...
void test_64() { vsprintf (buf, QUOTE(FMT_64), _va); }
void test_65() { vsprintf (buf, QUOTE(FMT_65), _va); }
void test_66() { vsprintf (buf, QUOTE(FMT_66), _va); }
void test_67() { vsprintf (buf, QUOTE(FMT_67), _va); }
void test_68() { vsprintf (buf, QUOTE(FMT_68), _va); }
void test_69() { vsprintf (buf, QUOTE(FMT_69), _va); }
void test_70() { vsprintf (buf, QUOTE(FMT_70), _va); }
void test_71() { vsprintf (buf, QUOTE(FMT_71), _va); }
void test_72() { vsprintf (buf, QUOTE(FMT_72), _va); }
void test_73() { vsprintf (buf, QUOTE(FMT_73), _va); }
void test_74() { vsprintf (buf, QUOTE(FMT_74), _va); }
void test_75() { vsprintf (buf, QUOTE(FMT_75), _va); }
void test_76() { vsprintf (buf, QUOTE(FMT_76), _va); }
void test_77() { vsprintf (buf, QUOTE(FMT_77), _va); }
void test_78() { vsprintf (buf, QUOTE(FMT_78), _va); }
void test_79() { vsprintf (buf, QUOTE(FMT_79), _va); }
void test_80() { vsprintf (buf, QUOTE(FMT_80), _va); }
void test_81() { vsprintf (buf, QUOTE(FMT_81), _va); }
void test_82() { vsprintf (buf, QUOTE(FMT_82), _va); }
void test_83() { vsprintf (buf, QUOTE(FMT_83), _va); }
void test_84() { vsprintf (buf, QUOTE(FMT_84), _va); }
void test_85() { vsprintf (buf, QUOTE(FMT_85), _va); }
void test_86() { vsprintf (buf, QUOTE(FMT_86), _va); }
void test_87() { vsprintf (buf, QUOTE(FMT_87), _va); }
void test_88() { vsprintf (buf, QUOTE(FMT_88), _va); }
void test_89() { vsprintf (buf, QUOTE(FMT_89), _va); }
void test_90() { vsprintf (buf, QUOTE(FMT_90), _va); }
void test_91() { vsprintf (buf, QUOTE(FMT_91), _va); }
void test_92() { vsprintf (buf, QUOTE(FMT_92), _va); }
void test_93() { vsprintf (buf, QUOTE(FMT_93), _va); }
void test_94() { vsprintf (buf, QUOTE(FMT_94), _va); }
void test_95() { vsprintf (buf, QUOTE(FMT_95), _va); }
void test_96() { vsprintf (buf, QUOTE(FMT_96), _va); }
void test_97() { vsprintf (buf, QUOTE(FMT_97), _va); }
void test_98() { vsprintf (buf, QUOTE(FMT_98), _va); }
void test_99() { vsprintf (buf, QUOTE(FMT_99), _va); }
void test_100() { vsprintf (buf, QUOTE(FMT_100), _va); }
void test_101() { vsprintf (buf, QUOTE(FMT_101), _va); }
void test_102() { vsprintf (buf, QUOTE(FMT_102), _va); }
void test_103() { vsprintf (buf, QUOTE(FMT_103), _va); }
void test_104() { vsprintf (buf, QUOTE(FMT_104), _va); }
void test_105() { vsprintf (buf, QUOTE(FMT_105), _va); }
void test_106() { vsprintf (buf, QUOTE(FMT_106), _va); }
void test_107() { vsprintf (buf, QUOTE(FMT_107), _va); }
void test_108() { vsprintf (buf, QUOTE(FMT_108), _va); }
void test_109() { vsprintf (buf, QUOTE(FMT_109), _va); }
void test_110() { vsprintf (buf, QUOTE(FMT_110), _va); }
void test_111() { vsprintf (buf, QUOTE(FMT_111), _va); }
void test_112() { vsprintf (buf, QUOTE(FMT_112), _va); }
void test_113() { vsprintf (buf, QUOTE(FMT_113), _va); }
void test_114() { vsprintf (buf, QUOTE(FMT_114), _va); }
void test_115() { vsprintf (buf, QUOTE(FMT_115), _va); }
void test_116() { vsprintf (buf, QUOTE(FMT_116), _va); }
void test_117() { vsprintf (buf, QUOTE(FMT_117), _va); }
void test_118() { vsprintf (buf, QUOTE(FMT_118), _va); }
void test_119() { vsprintf (buf, QUOTE(FMT_119), _va); }
void test_120() { vsprintf (buf, QUOTE(FMT_120), _va); }
void test_121() { vsprintf (buf, QUOTE(FMT_121), _va); }
void test_122() { vsprintf (buf, QUOTE(FMT_122), _va); }
void test_123() { vsprintf (buf, QUOTE(FMT_123), _va); }
void test_124() { vsprintf (buf, QUOTE(FMT_124), _va); }
void test_125() { vsprintf (buf, QUOTE(FMT_125), _va); }
void test_126() { vsprintf (buf, QUOTE(FMT_126), _va); }
void test_127() { vsprintf (buf, QUOTE(FMT_127), _va); }
...
/* { dg-final { scan-assembler-times "call _vsprintf_aAcdeEfFgGnopsuxX"  127 } } */
