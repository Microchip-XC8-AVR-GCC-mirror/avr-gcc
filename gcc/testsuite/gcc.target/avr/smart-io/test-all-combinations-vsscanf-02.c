...
/* { dg-final { scan-assembler-times "call _vsscanf_s"  1 } } */
/* { dg-final { scan-assembler-times "call _vsscanf_gGs"  2 } } */
/* { dg-final { scan-assembler-times "call _vsscanf_fFgGs"  4 } } */
/* { dg-final { scan-assembler-times "call _vsscanf_eEfFgGs"  8 } } */
/* { dg-final { scan-assembler-times "call _vsscanf_cdeEfFgGnopsuxX"  16 } } */
/* { dg-final { scan-assembler-times "call _vsscanf_aAcdeEfFgGnopsuxX"  32 } } */
