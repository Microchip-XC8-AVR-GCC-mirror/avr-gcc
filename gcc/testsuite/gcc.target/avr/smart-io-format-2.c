...
/* { dg-final { scan-assembler-times "call _printf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vprintf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _fprintf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vfprintf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _sprintf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vsprintf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _snprintf_cdfFnopuxX"  1 } } */
/* { dg-final { scan-assembler-times "call _vsnprintf_cdfFnopuxX"  1 } } */
